<template>
  <div>
    <header @wheel.prevent @touchmove.prevent @scroll.prevent>
      <div class="flex-align">
        <div class="logos flex-align">
          <svg class="burger" @click="isOpen = !isOpen" width="16" height="15" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg width="23" height="20" xmlns="http://www.w3.org/2000/svg" id="cart" @click="cart = !cart">
          <path
    ...
    <div class="cart-modal" v-if="cart"></div>
  </div>
</template>
...
.cart-modal {
  background-color: rgba(255, 207, 102, 0.7);
  position: absolute;
  z-index: 100;
  width: 750px;
  min-height: 800px;
