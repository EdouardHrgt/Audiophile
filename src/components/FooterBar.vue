<template>
  <div>
    <footer>
      <div class="footer-nav-logo flex-align">
      ...
      <div class="footer-txt-socials">
        <div class="footer-txt-socials-wrap flex-align">
          ...
          <ul class="footer-socials flex-align">
            <li>
